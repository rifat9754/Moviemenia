...
<head>
  ...
  <title>Moviemenia | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Moviemenia</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Ahanaf Tahmid Rifat</a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2024-2025 <a href="">Moviemenia.io</a>.</strong>
    All rights reserved.
...
<script src="{{ asset('dist/js/pages/dashboard.js')}}"></script>
        ...
        <script>
            ...
            CKEDITOR.ClassicEditor.create(document.getElementById("editor"), {
                ...
                fontSize: {
                    options: [ 10, 12, 14, 'default', 18, 20, 22,24,28,30 ],
                    supportAllValues: true
                },
